...
\newcommand{\MyName}{Lic. \FirstName\ \LastName}
...
\begin{EntriesTable}
  \Year{04/22}& \textbf{Gompertz Mixture with covariables for modeling COVID-19 pandemic.} CIMAT's summer school. Joint work with Dra. Graciela Gonzalez Farias.\\
...
\textbf{Programming:} \hspace{0.5 pt} \languageknowledge{LaTeX}{4} | \languageknowledge{Python}{4} | \languageknowledge{R}{3} | \languageknowledge{C/C++}{3}
